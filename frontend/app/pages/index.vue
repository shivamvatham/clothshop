<template>
  <div>
    <!-- Hero Section -->
    <section
      class="relative min-h-[85vh] flex items-center overflow-hidden bg-gradient-to-br from-orange-50 via-red-50 to-orange-100">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-10">
          <div class="text-center lg:text-left space-y-8">
            <div class="space-y-3">
              <div
                class="inline-block px-4 py-2 bg-white/30 backdrop-blur-sm rounded-full text-sm font-medium text-gray-700 border border-white/40 shadow-sm">
                ✨ New Collection {{ new Date().getFullYear() }}
              </div>
              <div class="flex items-center justify-center lg:justify-start space-x-3">
                <img src="/shreeFashion.png" alt="Shree Fashion" class="h-24 w-auto">
                <h1
                  class="text-4xl lg:text-6xl font-bold bg-gradient-to-r from-orange-600 via-red-600 to-orange-700 bg-clip-text text-transparent">
                  Shree Fashion
                </h1>
              </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <NuxtLink to="/new-arrivals"
                class="inline-flex items-center px-8 py-4 bg-white/80 backdrop-blur-sm text-gray-700 border-2 border-gray-200 rounded-xl font-semibold hover:border-orange-500 hover:text-orange-600 hover:-translate-y-1 transition-all duration-300 shadow-sm">
          ...
          <div class="relative max-w-lg mx-auto">
            <div class="relative">
              <img src="https://cdn.pixabay.com/photo/2024/07/02/07/58/dress-8866994_1280.jpg"
                alt="Elegant Fashion Collection" class="w-full h-[600px] object-cover rounded-3xl shadow-2xl">
              <!-- <div class="absolute inset-0 bg-gradient-to-t from-orange-500/20 via-transparent to-red-500/20 rounded-3xl"></div> -->
            </div>
            <div
              class="absolute -bottom-6 -left-6 lg:block hidden bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-white/20">
    ...
    <!-- Category Cards -->
    <section class="py-12 bg-gradient-to-r from-orange-500/10 via-red-500/10 to-orange-400/10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
          <div>
            <h2 class="text-2xl font-bold text-gray-900 mb-1">
              Shop by <span
                class=" bg-gradient-to-br from-orange-50 via-red-50 to-orange-100 bg-clip-text text-transparent">Category</span>
            </h2>
            <p class="text-gray-600">Discover our premium collections</p>
          </div>
          <NuxtLink to="/products"
            class="hidden md:inline-flex items-center text-orange-600 hover:text-orange-700 font-medium text-sm">
            View All
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <!-- Kurtis Category -->
          <NuxtLink to="/products?category=kurtis"
            class="group relative bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 border border-orange-100">
            <div class="flex items-center space-x-4">
              <div class="w-16 h-16 rounded-full overflow-hidden flex-shrink-0">
                <img src="https://cdn.pixabay.com/photo/2024/07/02/07/58/dress-8866994_1280.jpg" alt="Kurtis"
          ...
          <!-- Sarees Category -->
          <NuxtLink to="/products?category=sarees"
            class="group relative bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 border border-red-100">
            <div class="flex items-center space-x-4">
              <div class="w-16 h-16 rounded-full overflow-hidden flex-shrink-0">
                <img
                  src="https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=100&h=100&fit=crop&auto=format&q=80"
                  alt="Sarees" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
              </div>
              <div class="flex-1">
          ...
          <!-- Dresses Category -->
          <NuxtLink to="/products?category=dresses"
            class="group relative bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 border border-orange-100">
            <div class="flex items-center space-x-4">
              <div class="w-16 h-16 rounded-full overflow-hidden flex-shrink-0">
                <img
